...
def run(playwright):
    ...
    # 2. Log in using authentic credentials path
    ...
    # 3. Inspect and clear the image blocker rule so buttons can build
    ...
    # Target button using exact string matcher structure to bypass similarity conflicts
    ...
    # 🌟 CRITICAL FIX: Use exact regex matching to isolate "India" from "British Indian Ocean"
    # The '.*' patterns safely allow the unicode/icon character inside the button name string
    ...
    # Confirm the UI printed our injected value
